  ...
  function srcAppFolderTmsTmsServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var TmsService = /*#__PURE__*/function () {
      ...
      _createClass(TmsService, [{
        key: "getTaskList",
        value: function getTaskList(userId, startDate, endDate) {
          return this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_8__["environment"].urlPHP + 'task/getmytasks/' + userId + '/' + startDate + '/' + endDate).map(function (Response) {
            return Response;
          })["catch"](this.handleErrors);
        }
      }, {
        key: "getMyTasksList",
        value: function getMyTasksList(userId) {
          return this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_8__["environment"].urlPHP + 'task/getmytaskslist/' + userId).map(function (Response) {
            return Response;
          })["catch"](this.handleErrors);
        }
      }, {
        ...
        value: function taskDes(id) {
          return this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_8__["environment"].urlPHP + 'task/gettaskdetails/' + id).map(function (Response) {
            return Response;
          })["catch"](this.handleErrors);
        }
      }, {
        ...
        value: function updateTaskStatus(id, status) {
          return this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_8__["environment"].urlPHP + 'task/updatetaskstatus/' + id + '/' + status).map(function (Response) {
            return Response;
          })["catch"](this.handleErrors);
        }
      }, {
        key: "updateEndTaskStatus",
        value: function updateEndTaskStatus(id, status, dt) {
          var payload = {
            "endTime": dt,
            "stage": status,
            "taskid": id
          };
          return this.http.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_8__["environment"].urlPHP + 'task/updateEndtaskstatus/', payload).map(function (Response) {
            return Response;
          })["catch"](this.handleErrors);
        }
      }, {
        ...
        value: function lastTaskStatus(id) {
          return this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_8__["environment"].urlPHP + 'task/laststatus/' + id).map(function (Response) {
            return Response;
          })["catch"](this.handleErrors);
        }
      }, {
        ...
        value: function timeSpent(id) {
          return this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_8__["environment"].urlPHP + 'task/gettimespentintask/' + id).map(function (Response) {
            return Response;
          })["catch"](this.handleErrors);
        }
      }, {
        ...
        value: function getCompanies() {
          return this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_8__["environment"].urlPHP + 'task/get_companies').map(function (Response) {
            return Response;
          })["catch"](this.handleErrors);
        }
      }, {
        ...
        value: function getTaskname() {
          return this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_8__["environment"].urlPHP + 'task/checkTaskname').map(function (Response) {
            return Response;
          })["catch"](this.handleErrors);
        }
      }, {
        ...
        value: function getProject(id) {
          return this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_8__["environment"].urlPHP + 'task/get_projects/' + id).map(function (Response) {
            return Response;
          })["catch"](this.handleErrors);
        }
      }, {
        ...
        value: function createTask(data) {
          return this.http.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_8__["environment"].urlPHP + 'task/create_task', data).map(function (Response) {
            return Response;
          })["catch"](this.handleErrors);
        }
      }, {
