...
let CheckinComponent = class CheckinComponent {
    constructor(geolocation, checkSer, storage, nativeStorage, router, route, tmsSrv, alertController, nativeGeocoder) {
        ...
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            const alert = yield this.alertController.create({
                ...
                buttons: [{
                        text: "OK",
                        handler: () => {
                            this.tmsSrv.updateTaskStatus(this.id, 'Completed').subscribe(res => {
                                // console.log(res);
                                this.completed();
...
const routes = [
    ...
    {
        path: 'punch',
        loadChildren: () => __webpack_require__.e(/*! import() | check-incheck-out-check-incheck-out-module */ "check-incheck-out-check-incheck-out-module").then(__webpack_require__.bind(null, /*! ./check-incheck-out/check-incheck-out.module */ "./src/app/folder/check-incheck-out/check-incheck-out.module.ts")).then(m => m.CheckIncheckOutModule)
    },
    {
        path: 'attendanceRep',
        loadChildren: () => Promise.all(/*! import() | attendance-report-attendance-report-module */[__webpack_require__.e("default~attendance-report-attendance-report-module~leave-leave-module"), __webpack_require__.e("attendance-report-attendance-report-module")]).then(__webpack_require__.bind(null, /*! ./attendance-report/attendance-report.module */ "./src/app/folder/attendance-report/attendance-report.module.ts")).then(m => m.AttendanceReportModule)
    },
    {
        path: 'leave',
        loadChildren: () => Promise.all(/*! import() | leave-leave-module */[__webpack_require__.e("default~attendance-report-attendance-report-module~leave-leave-module"), __webpack_require__.e("leave-leave-module")]).then(__webpack_require__.bind(null, /*! ./leave/leave.module */ "./src/app/folder/leave/leave.module.ts")).then(m => m.LeaveModule)
    },
    {
        path: 'signUp',
    ...
    {
        path: 'tms',
        loadChildren: () => __webpack_require__.e(/*! import() | tms-tms-module */ "tms-tms-module").then(__webpack_require__.bind(null, /*! ./tms/tms.module */ "./src/app/folder/tms/tms.module.ts")).then(m => m.TmsModule)
    }
];
...
/* harmony import */ var _check_incheck_out_checkin_checkin_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./check-incheck-out/checkin/checkin.component */ "./src/app/folder/check-incheck-out/checkin/checkin.component.ts");
...
let TmsService = class TmsService {
    ...
    //  }
    getTaskList(userId) {
        return this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_8__["environment"].urlPHP + 'task/getmytasks/' + userId, this.httpOptions)
            .map(Response => { return Response; }).catch(this.handleErrors);
    }
    taskDes(id) {
        return this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_8__["environment"].urlPHP + 'task/gettaskdetails/' + id, this.httpOptions)
            .map(Response => { return Response; }).catch(this.handleErrors);
    }
    taskLoc(id, status) {
        return this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_8__["environment"].urlPHP + 'task/get_tasks/' + id + '/' + status)
            .map(Response => { return Response; }).catch(this.handleErrors);
    }
    updateTaskStatus(id, status) {
        return this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_8__["environment"].urlPHP + 'task/updatetaskstatus/' + id + '/' + status, this.httpOptions)
            .map(Response => { return Response; }).catch(this.handleErrors);
    }
    lastTaskStatus(id) {
        return this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_8__["environment"].urlPHP + 'task/laststatus/' + id, this.httpOptions)
            .map(Response => { return Response; }).catch(this.handleErrors);
    }
    timeSpent(id) {
        return this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_8__["environment"].urlPHP + 'task/gettimespentintask/' + id, this.httpOptions)
            .map(Response => { return Response; }).catch(this.handleErrors);
    }
    getCompanies() {
        return this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_8__["environment"].urlPHP + 'task/get_companies', this.httpOptions)
            .map(Response => { return Response; }).catch(this.handleErrors);
    }
    getTaskname() {
        return this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_8__["environment"].urlPHP + 'task/checkTaskname', this.httpOptions)
            .map(Response => { return Response; }).catch(this.handleErrors);
    }
    getProject(id) {
        return this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_8__["environment"].urlPHP + 'task/get_projects/' + id, this.httpOptions)
            .map(Response => { return Response; }).catch(this.handleErrors);
    }
    createTask(data) {
        return this.http.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_8__["environment"].urlPHP + 'task/create_task', data, this.httpOptions)
            .map(Response => { return Response; }).catch(this.handleErrors);
    }
    handleErrors(error) {
...
TmsService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] },
    { type: _ionic_storage__WEBPACK_IMPORTED_MODULE_9__["Storage"] }
];
TmsService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
    })
], TmsService);
