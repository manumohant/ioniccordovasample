...
let LeaveSummaryComponent = class LeaveSummaryComponent {
    ...
    getLeaves() {
        ...
        let firstDay = moment__WEBPACK_IMPORTED_MODULE_4__(this.firstDay).format('YYYY-MM-DD');
        let lastDay = moment__WEBPACK_IMPORTED_MODULE_4__(this.lastDay).format('YYYY-MM-DD');
