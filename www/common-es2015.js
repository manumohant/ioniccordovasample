...
let TmsService = class TmsService {
    ...
    getTaskList(userId, startDate, endDate) {
        return this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_8__["environment"].urlPHP + 'task/getmytasks/' + userId + '/' + startDate + '/' + endDate)
            .map(Response => { return Response; }).catch(this.handleErrors);
    }
    getMyTasksList(userId) {
        return this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_8__["environment"].urlPHP + 'task/getmytaskslist/' + userId)
            .map(Response => { return Response; }).catch(this.handleErrors);
    }
    taskDes(id) {
        return this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_8__["environment"].urlPHP + 'task/gettaskdetails/' + id)
            .map(Response => { return Response; }).catch(this.handleErrors);
    }
    taskLoc(id, status) {
    ...
    updateTaskStatus(id, status) {
        return this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_8__["environment"].urlPHP + 'task/updatetaskstatus/' + id + '/' + status)
            .map(Response => { return Response; }).catch(this.handleErrors);
    }
    updateEndTaskStatus(id, status, dt) {
        ...
        return this.http.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_8__["environment"].urlPHP + 'task/updateEndtaskstatus/', payload)
            .map(Response => { return Response; }).catch(this.handleErrors);
    }
    lastTaskStatus(id) {
        return this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_8__["environment"].urlPHP + 'task/laststatus/' + id)
            .map(Response => { return Response; }).catch(this.handleErrors);
    }
    timeSpent(id) {
        return this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_8__["environment"].urlPHP + 'task/gettimespentintask/' + id)
            .map(Response => { return Response; }).catch(this.handleErrors);
    }
    getCompanies() {
        return this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_8__["environment"].urlPHP + 'task/get_companies')
            .map(Response => { return Response; }).catch(this.handleErrors);
    }
    getTaskname() {
        return this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_8__["environment"].urlPHP + 'task/checkTaskname')
            .map(Response => { return Response; }).catch(this.handleErrors);
    }
    getProject(id) {
        return this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_8__["environment"].urlPHP + 'task/get_projects/' + id)
            .map(Response => { return Response; }).catch(this.handleErrors);
    }
    createTask(data) {
        return this.http.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_8__["environment"].urlPHP + 'task/create_task', data)
            .map(Response => { return Response; }).catch(this.handleErrors);
    }
    handleErrors(error) {
