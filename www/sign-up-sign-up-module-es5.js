...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["sign-up-sign-up-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppFolderSignUpTermsconditionsTermsconditionsComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppFolderSignUpLoginLoginComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _ionic_native_uid_ngx__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! @ionic-native/uid/ngx */
    "./node_modules/@ionic-native/uid/__ivy_ngcc__/ngx/index.js");
    /* harmony import */


    var _ionic_native_unique_device_id_ngx__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    ...
    var LoginComponent = /*#__PURE__*/function () {
      function LoginComponent(router, loginSer, storage, nativeStorage, uniqueDeviceID, uid, androidPermissions, translate) {
        var _this = this;
        ...
        this.translate.get('Permission granted').subscribe(function (value) {
          _this.permGrant = value;
        });
        this.translate.get('Login failed').subscribe(function (value) {
          _this.loginFailed = value;
        });
        this.translate.get('Invalid credentials').subscribe(function (value) {
          _this.invalidCred = value;
      ...
      _createClass(LoginComponent, [{
        ...
        value: function login() {
          ...
          this.loginSer.login(loginData).subscribe(function (res) {
            ...
            _this3.storage.set('ion_did_login', false);
            ...
            if (res['data'] == 'Login failed') {
              _this3.errMsg = _this3.loginFailed;
              _this3.showSpinner = false;
              ...
              if (res['data'].tcflag == 1) {
                _this3.router.navigateByUrl('/folder/tms/mytask');
              } else {
                _this3.router.navigateByUrl('/folder/signUp/terms');
              }
            } else {
              _this3.errMsg = _this3.invalidCred;
              _this3.showSpinner = false;
            }
          }, function (error) {
            _this3.showSpinner = false;
            _this3.errMsg = error.error.data;
          });
        }
      }, {
        key: "register",
  ...
  function srcAppFolderSignUpRegisterRegisterComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _sign_up_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ../sign-up.service */
    "./src/app/folder/sign-up/sign-up.service.ts");
    /* harmony import */
    ...
    var RegisterComponent = /*#__PURE__*/function () {
      function RegisterComponent(router, loginSer, storage, nativeStorage, uniqueDeviceID, uid, androidPermissions, translate) {
        var _this4 = this;
        ...
        this.translate.get('Permission granted').subscribe(function (value) {
          _this4.permGrant = value;
        });
        this.translate.get('User exists').subscribe(function (value) {
          _this4.userExist = value;
        });
        this.translate.get('UUID exists').subscribe(function (value) {
          _this4.uuidExist = value;
        });
        this.translate.get('Employee exists').subscribe(function (value) {
          _this4.empExist = value;
        });
        this.translate.get('Password mismatch').subscribe(function (value) {
          _this4.pwdMismatch = value;
        }); //Check Permission on App Start
      ...
      _createClass(RegisterComponent, [{
        ...
        value: function getPermission() {
          ...
          this.androidPermissions.checkPermission(this.androidPermissions.PERMISSION.READ_PHONE_STATE).then(function (res) {
            if (res.hasPermission) {
              _this5.uniqueID = _this5.getID_UID("UUID");
            } else {
              _this5.androidPermissions.requestPermission(_this5.androidPermissions.PERMISSION.READ_PHONE_STATE).then(function (res) {
                if (res.hasPermission) {
                  alert(_this5.permGrant);
                }
              })["catch"](function (error) {
                alert("Error! " + error);
              });
        ...
        value: function register() {
          ...
          if (this.uniqueID == '' || this.uniqueID == null) {
            ...
            this.loginSer.register(registerData).subscribe(function (res) {
              if (res['data'] == "User exists") {
                _this6.errMsg = _this6.userExist;
                _this6.showSpinner = false;
              } else if (res['data'] == "UUID exists") {
                _this6.errMsg = _this6.uuidExist;
                _this6.showSpinner = false;
              } else if (res['data'] == "Employee doesn't exist") {
                _this6.errMsg = _this6.empExist;
                _this6.showSpinner = false;
              } else if (res['data'] == "User Registration Successful") {
                _this6.router.navigateByUrl('/folder/signUp/login');
              }
            }, function (error) {
              _this6.showSpinner = false;
              _this6.errMsg = error.error.data;
            });
          } else {
  ...
  function srcAppFolderSignUpSignUpRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _termsconditions_termsconditions_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
  ...
  function srcAppFolderSignUpSignUpModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _termsconditions_termsconditions_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
    /*! ./termsconditions/termsconditions.component */
    "./src/app/folder/sign-up/termsconditions/termsconditions.component.ts");
    ...
    SignUpModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      declarations: [_about_about_component__WEBPACK_IMPORTED_MODULE_4__["AboutComponent"], _login_login_component__WEBPACK_IMPORTED_MODULE_6__["LoginComponent"], _register_register_component__WEBPACK_IMPORTED_MODULE_8__["RegisterComponent"], _termsconditions_termsconditions_component__WEBPACK_IMPORTED_MODULE_12__["TermsconditionsComponent"]],
  ...
  function srcAppFolderSignUpSignUpServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var SignUpService = /*#__PURE__*/function () {
      ...
      _createClass(SignUpService, [{
        ...
        key: "termsConditions",
        value: function termsConditions(userId, terms) {
          return this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_8__["environment"].urlPHP + 'auth/updateTc/' + userId + '/' + terms).map(function (Response) {
            return Response;
          })["catch"](this.handleErrors);
        }
      }, {
        ...
        value: function register(data) {
          return this.http.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_8__["environment"].urlPHP + 'auth/register', data).map(function (Response) {
            return Response;
          })["catch"](this.handleErrors);
        }
      }, {
  ...
  /***/
  function srcAppFolderSignUpTermsconditionsTermsconditionsComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppFolderSignUpTermsconditionsTermsconditionsComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _sign_up_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ../sign-up.service */
    "./src/app/folder/sign-up/sign-up.service.ts");

    var TermsconditionsComponent = /*#__PURE__*/function () {
      function TermsconditionsComponent(alertController, router, loginSer) {
      ...
      _createClass(TermsconditionsComponent, [{
        ...
        key: "termsAccepted",
        value: function termsAccepted() {
          var _this7 = this;

          this.terms = 1;
          this.loginSer.termsConditions(this.userId, this.terms).subscribe(function (res) {
            if (res['data'] == 1) {
              window.localStorage.setItem('terms', '1');
            }
          }, function (error) {
            _this7.showSpinner = false;
            _this7.errTitle = 'Error!';
            _this7.errMsg = error;

            _this7.showAlert(_this7.errTitle, _this7.errMsg);
          });
    ...
    TermsconditionsComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-termsconditions',
      template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! raw-loader!./termsconditions.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/folder/sign-up/termsconditions/termsconditions.component.html"))["default"],
      styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! ./termsconditions.component.scss */
      "./src/app/folder/sign-up/termsconditions/termsconditions.component.scss"))["default"]]
